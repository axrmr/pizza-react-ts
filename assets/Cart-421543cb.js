...
to {
  ...
  animation: ${zt} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,$t=({toast:t})=>{let{icon:e,type:s,iconTheme:o}=t;return e!==void 0?typeof e=="string"?d.createElement(Lt,null,e):e:s==="blank"?null:d.createElement(Nt,null,d.createElement(wt,{...o}),s!=="loading"&&d.createElement(_t,null,s==="error"?d.createElement(vt,{...o}):d.createElement(Et,{...o})))},Pt=t=>`
